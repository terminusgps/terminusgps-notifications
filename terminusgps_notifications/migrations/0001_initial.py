# Generated by Django 5.2.8 on 2025-11-12 22:24
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subtotal_base', models.DecimalField(decimal_places=2, default=60.0, help_text='Enter a base dollar amount to charge the customer for service (not incl. tax) every period.', max_digits=9)),
                ...
                ('executions_max', models.PositiveIntegerField(default=500, verbose_name='maximum executions')),
                ('executions_max_base', models.PositiveIntegerField(default=500, verbose_name='maximum executions base')),
                ('executions_count', models.PositiveIntegerField(default=0, verbose_name='current executions')),
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'extension package',
                'verbose_name_plural': 'extension packages',
            },
        ),
        migrations.CreateModel(
