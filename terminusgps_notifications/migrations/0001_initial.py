# Generated by Django 5.2.8 on 2025-11-07 18:29
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('max_executions', models.PositiveIntegerField(default=500, help_text='Enter the maximum number of allowed notification executions in a single period.')),
                ...
                ('subtotal', models.DecimalField(decimal_places=2, default=64.99, help_text='Enter a dollar amount to charge the customer (not incl. tax) every period.', max_digits=9)),
