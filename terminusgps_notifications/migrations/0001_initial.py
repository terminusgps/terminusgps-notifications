...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date_format', models.CharField(choices=[('%Y-%m-%d %H:%M:%S', 'YYYY-MM-DD HH:MM:SS'), ('%Y-%m-%d %H:%M', 'YYYY-MM-DD HH:MM')], default='%Y-%m-%d %H:%M:%S', max_length=64)),
                ('resource_id', models.CharField(blank=True, default=None, help_text='Please enter an 8-digit Wialon resource id to create notifications in.', max_length=8, null=True, validators=[terminusgps.validators.validate_is_digit, django.core.validators.MinLengthValidator(8)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('units', models.CharField(default='')),
                ...
                ('trigger', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='notifications', to='terminusgps_notifications.wialonnotificationtrigger')),
            ],
            options={
